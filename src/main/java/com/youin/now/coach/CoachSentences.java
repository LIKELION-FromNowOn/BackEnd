...
public final class CoachSentences {
    ...
    public static final List<String> BANNED = List.of(
            "치료됩니다", "치료돼", "치료가됩니다",
            "효과가있습니다", "효과적입니다", "에좋습니다", "완치");
    // 2026-08-20 네 개를 뺐습니다. 넓으면 멀쩡한 답이 계속 버려집니다.
    //
    //   ★ 「낫습니다」 — 이게 제일 나빴습니다. 한국어에서 「치유된다」와 「더 낫다」가
    //     같은 말입니다. 제 폴백 문장 「하지 않으시는 편이 낫습니다」가 스스로 걸렸습니다.
    //     실서버에서 LLM 답이 이것 때문에 전부 버려졌습니다.
    //   「나아집니다」도 같은 이유입니다.
    //   「권장합니다」와 「처방」 —
    //   실서버에서 멀쩡한 답이 이 둘 때문에 계속 버려졌습니다.
    //   「클리닉에서 처방받으신 약은…」 같은 문장은 막을 이유가 없습니다.
    //   ★ 비교는 공백을 지운 뒤에 합니다. 목록도 공백 없이 적어야 합니다
}
