...
| 41 | claude | **뷰티 문장이 위기 신호로 잘못 잡힙니다.** `[측]` 「여드름 자국 없어지고 싶어요」·「기미 사라지고 싶다」가 **둘 다 걸립니다** — 확정 키워드의 「없어지고 싶」·「사라지고 싶」에 닿습니다. **김민정 님이 확정본을 주시며 직접 지적하신 것**입니다. ⚠️ **놓치는 것이 잘못 잡는 것보다 훨씬 나쁘므로 지금은 그대로 다 잡습니다.** 줄이려면 **그 두 키워드에 한해, 바로 앞 4글자 안에 피부 명사**(자국·흉터·여드름·기미·잡티·점·주름·모공·튼살·붓기·다크서클·각질·홍조·색소)가 붙었을 때만 빼는 방법이 있습니다. **「바로 앞」이 핵심**입니다 — 「문장에 피부 단어가 있으면 뺀다」로 하면 **「여드름 때문에 사라지고 싶어요」를 놓칩니다.** 다른 키워드가 하나라도 같이 걸리면 무조건 잡습니다. **넣을지는 김민정 님이 정하십니다** | 김민정 |
